...
class ChatDetailPage extends StatefulWidget {
  ...
  const ChatDetailPage({required Key key, required this.name, required this.img}) : super(key: key);
  @override
      ...
      child: ListView(
          ...
          children: List.generate(messages.length, (index) {
            return CustomBubbleChat(
              ...
              time: messages[index]['time'], key: '1' as Key,
            );
          })),
    );
  }
...
class CustomBubbleChat extends StatelessWidget {
  ...
  const CustomBubbleChat(
      {required Key key, required this.isMe, required this.message, required this.time, required this.isLast})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    if (isMe) {
